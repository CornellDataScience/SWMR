...
class Glove(object):
    ...
    def __init__(self, pre_trained=True):
        self.GLOVE_PATH = os.path.dirname(os.getcwd()) + '/QuACC/model/glove.840B.300d.zip'
...
class Word2Vec(object):
    ...
    """
    def __init__(self):
        self.WORD2VEC_PATH = os.path.dirname(os.getcwd()) + '/QuACC/model/GoogleNews-vectors-negative300.bin'
